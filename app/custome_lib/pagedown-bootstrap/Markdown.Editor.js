...
(function () {
    ...
    ui.prompt = function (title, text, defaultInputText, callback) {
        ...
        var createDialog = function () {
            ...
            // Added by xuhua.
            var thisDialog = doc.createElement("div");
            thisDialog.className = "modal-dialog";
            dialog.appendChild(thisDialog);
            ...
            header.innerHTML = '<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> <h3>'+title+'</h3>';
